...
当前证据基线：`config_id=2e43779d-9f73-4d5e-b09d-22a19f0346fa`，当前主配置 `exp_name=agentquant-futures-trading`，覆盖 2025-07-01 至 2025-08-29 共 44 个交易日。基线包含 60 笔成交、18 个完整 episode、178 条未交易记忆、37 条探索假设和 1980 份分析师 signal；旧实验只用于修改前后对照。下一轮从 2025-09-01 接续同一实验链，继续验收盈利完全回吐的既有减仓复核口径。
