...
当前证据基线：`config_id=2e43779d-9f73-4d5e-b09d-22a19f0346fa`，`exp_name=agentquant-futures-trading-2025-rag-retest-202507-08`，覆盖 2025-07-01 至 2025-08-29 共 44 个交易日。基线包含 60 笔成交、18 个完整 episode、178 条未交易记忆、37 条探索假设和 1980 份分析师 signal；旧实验只用于修改前后对照。本清单中的探索仓盈利完全回吐后全部退出规则是在该基线之后修改，必须由下一轮同窗口实验重新验收。
