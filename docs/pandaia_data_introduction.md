...
本文档说明 AgentQuant 当前如何使用 PandaAI 数据，以及优化后 PandaAI 在日频策略生成和盘中执行确认中的角色。
...
这些数据主要用于 `market_confirmation`，不直接替代分析师信号。
...
src/apis/router.py
src/tools/agent_tools/market_confirmation.py
