...
def build_researcher_causal_review_prompt(evidence_json: str) -> str:
    ...
    return (
        ...
        "If Reviewer provides budget_drift_diagnostics, warnings, or factual attribution for PM plan budget drift, "
        "treat them only as research input and factual attribution. PM plan budget parameters such as "
        "max_net_exposure, target_margin_ratio_*, probe_margin_ratio, strong_opportunity_*, and recovery_* "
...
def build_researcher_exploratory_prompt(*, trading_date: str, episodes_json: str) -> str:
    ...
    return (
        ...
        "For each hypothesis, include setup_type, support_episode_ids, entry_timing_hint, exit_timing_hint, holding_period_hint, "
