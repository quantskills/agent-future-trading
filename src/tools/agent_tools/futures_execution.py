...
from tools.agent_tools.futures_commission import (
...
class FuturesExecutionEngine:
    ...
    def _build_transaction(
        ...
        margin_rate = contract_info["margin_rate_long"] if action_value in {
            RecommendationAction.OPEN_LONG.value,
    ...
    def apply_transaction_to_portfolio(self, portfolio, transaction: FuturesTransaction):
        ...
        if transaction.action == FuturesAction.OPEN_LONG:
            ...
            portfolio.cashflow -= transaction.commission
            ...
            if position.entry_price is not None:
                ...
                portfolio.cashflow += realized_pnl - transaction.commission
            position.shares -= lots
        ...
        denominator = portfolio.cashflow + portfolio.margin_used
