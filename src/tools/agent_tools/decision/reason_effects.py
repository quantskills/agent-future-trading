...
def reason_effect_summary(
    ...
    *,
    ...
    soft_limits = [
        ...
        if reason not in hard_blocks and is_soft_limit_reason(reason)
    ]
    ...
    known = set(hard_blocks) | set(soft_limits) | set(learning_adjustments) | set(release_signals)
    ...
    return {
        ...
        "boundary": (
            "hard_blocks may stop new exposure; soft_limits can only cap/probe/watchlist; "
            "learning_adjustments must be scoped, expiring, and reversible; release_signals "
