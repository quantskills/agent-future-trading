...
def build_default_agent_cards() -> Dict[str, AgentCapabilityCard]:
    cards = [
        AgentCapabilityCard(
            ...
            team="analysis_team",
            reads=["market_data", "technical_context", "product_price_behavior_profile", "past_learning_context"],
            writes=["AnalystSignalArtifact"],
            outputs=["action_evidence_contract", "trade_research_contract", "product_profile_evidence", "fusion_evidence"],
            may_call_llm=True,
        ...
        AgentCapabilityCard(
            ...
            team="analysis_team",
            reads=[
                "finoview_fundamental_data",
                "pandaai_factor_context",
                "product_price_behavior_profile",
                "past_learning_context",
            ],
            writes=["AnalystSignalArtifact"],
            outputs=["action_evidence_contract", "trade_research_contract", "product_profile_evidence", "fusion_evidence"],
            may_call_llm=True,
        ...
        AgentCapabilityCard(
            ...
            team="analysis_team",
            reads=["local_news", "event_context", "product_price_behavior_profile", "past_learning_context"],
            writes=["AnalystSignalArtifact"],
            outputs=["action_evidence_contract", "trade_research_contract", "product_profile_evidence", "fusion_evidence"],
            may_call_llm=True,
            required_contract_versions=["agentquant.message.v1", "agentquant.research.v1"],
        ...
        AgentCapabilityCard(
            ...
            team="decision_team",
            reads=["action_evidence_contract", "product_profile_evidence", "fusion_evidence", "AnalystSignalArtifact"],
            writes=["SignalCollectionArtifact"],
            outputs=["signal_collection_contract", "evidence_fusion"],
            may_call_llm=False,
        ...
        AgentCapabilityCard(
            agent_name="auditor",
            team="decision_team",
            reads=["final_action_contract", "risk_state", "contract_state", "pm_fusion_diagnostics"],
        ...
        AgentCapabilityCard(
            agent_name="reviewer",
            team="research_team",
            reads=["settlement_artifacts", "execution_artifacts", "decision_artifacts", "pm_fusion_diagnostics"],
        ...
        AgentCapabilityCard(
            ...
            team="research_team",
            reads=["reviewer_artifacts", "settled_trade_episodes", "action_outcomes", "fusion_attribution_label"],
