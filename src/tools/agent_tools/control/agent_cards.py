...
from tools.agent_tools.control.schemas import AgentCapabilityCard, ProtocolCheckResult
...
def build_default_agent_cards() -> Dict[str, AgentCapabilityCard]:
    cards = [
        ...
        AgentCapabilityCard(
            ...
            writes=["ReviewerAttributionArtifact", "ReviewerLearningArtifact"],
            outputs=["attribution", "learning_candidates"],
            may_call_llm=False,
            may_write_future_learning=True,
            failure_mode="write_insufficient_evidence_candidate",
        ),
        AgentCapabilityCard(
