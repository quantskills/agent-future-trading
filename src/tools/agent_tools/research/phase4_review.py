...
def _write_historical_learning_snapshot_report(
    *,
    ...
    """Write a read-only Phase4 historical learning snapshot for audit and replay."""
    ...
    historical_adaptive_policy_snapshot = _report_rows(
        cursor,
        '''
        SELECT *
    ...
    historical_capital_deployment_rows = _report_rows(
        cursor,
        '''
        SELECT *
