    ...
    *,
    ...
    cursor.execute(
        ...
        (
            ...
            str(sample.get("action_taken") or ""),
            str(sample.get("pm_action") or ""),
            str(sample.get("auditor_decision") or ""),
            str(sample.get("trader_status") or ""),
            _safe_int(sample.get("target_lots")),
            _safe_int(sample.get("executed_lots")),
            _safe_float(sample.get("net_pnl")),
            _safe_float(sample.get("commission")),
    ...
    for action_name, raw_action_rows in grouped.items():
        ...
        cursor.execute(
            ...
            (
                ...
                config_id,
                scope_key,
                str(profile_scope.get("ticker") or "*").upper(),
                str(profile_scope.get("side") or "*"),
                str(profile_scope.get("horizon_class") or "*"),
                str(profile_scope.get("market_regime") or "*"),
                str(profile_scope.get("setup_type") or "*"),
                str(profile_scope.get("data_combo") or "*"),
                action_name,
                sample_count,
                reward_sum,
                reward_mean,
